...
void cropDisplay(int row, int col, char numArray[][col], char dispArray[][col]);
//=====================================================================================================================
int main(){
...
void crop(char chararray[][X_SIZE], char image_array[][X_SIZE], FILE* imagefileptr, int *colm, char *filename, int rowSize, int colSize){
	...
	char newArray[y][x];
	char displayArray[y][x];
	
	//copy cropped part to new array
	for(int a = 0; a < y; a++){
		for(int b = 0; b < x; b++){
	...
	//convert nums to characters
	cropDisplay(y, x, newArray, displayArray);
...
void cropDisplay(int row, int col, char numArray[][col], char dispArray[][col]){
	...
	for(int a = 0; a < row; a++){
		for(int b = 0; b < col; b++){
			if(numArray[a][b] == '0'){
				dispArray[a][b] = ' ';
			}else if(numArray[a][b] == '1'){
				dispArray[a][b] = '.';
			}else if(numArray[a][b] == '2'){
				dispArray[a][b] = 'o';
			}else if(numArray[a][b] == '3'){
				dispArray[a][b] = 'O';
			}else if(numArray[a][b] == '4'){
				dispArray[a][b] = '0';
			}
			printf("%c", dispArray[a][b]);
		}
		printf("\n");
	}
}
